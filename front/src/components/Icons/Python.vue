<template>
    <svg enable-background="new 0.21 -0.077 110 110" height="110px"
         version="1.1" viewBox="0.21 -0.077 110 110"
         width="110px" x="0px" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:cc="http://web.resource.org/cc/"
         xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:svg="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
         y="0px"><linearGradient id="SVGID_1_" gradientTransform="matrix(1 0 0 -1 -53.2974 66.4321)" gradientUnits="userSpaceOnUse" x1="63.8159" x2="118.4934" y1="56.6829" y2="1.8225"> <stop
        offset="0" style="stop-color:#387EB8"/> <stop offset="1" style="stop-color:#366994"/></linearGradient>
        <path d="M55.023-0.077c-25.971,0-26.25,10.081-26.25,12.156c0,3.148,0,12.594,0,12.594h26.75v3.781 c0,0-27.852,0-37.375,0c-7.949,0-17.938,4.833-17.938,26.25c0,19.673,7.792,27.281,15.656,27.281c2.335,0,9.344,0,9.344,0 s0-9.765,0-13.125c0-5.491,2.721-15.656,15.406-15.656c15.91,0,19.971,0,26.531,0c3.902,0,14.906-1.696,14.906-14.406 c0-13.452,0-17.89,0-24.219C82.054,11.426,81.515-0.077,55.023-0.077z M40.273,8.392c2.662,0,4.813,2.15,4.813,4.813 c0,2.661-2.151,4.813-4.813,4.813s-4.813-2.151-4.813-4.813C35.46,10.542,37.611,8.392,40.273,8.392z"
              fill="url(#SVGID_1_)"/>
        <linearGradient id="SVGID_2_" gradientTransform="matrix(1 0 0 -1 -53.2974 66.4321)" gradientUnits="userSpaceOnUse" x1="97.0444" x2="155.6665"
                        y1="21.6321" y2="-34.5308"> <stop offset="0"
                                                                                                   style="stop-color:#FFE052"/>
            <stop offset="1" style="stop-color:#FFC331"/></linearGradient>

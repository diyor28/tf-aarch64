<template>
    <svg id="svg8" height="122.83399"
         version="1.1" viewBox="0 0 30.31081 32.499828"
         width="114.56054" xmlns="http://www.w3.org/2000/svg" xmlns:cc="http://creativecommons.org/ns#" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#"
        ...
        <g id="layer1" transform="translate(-77.942529,-177.00005)">
            <g id="g4550">
                <path id="path4508"
                      ...
                      style="fill:#e55b2d;fill-opacity:1" transform="scale(0.26458333)"/>
                <path id="path4491"
                      ...
                      style="fill:#ed8e24;fill-opacity:1" transform="scale(0.26458333)"/>
                <path id="path4506"
                      ...
                      style="fill:#f8bf3c;fill-opacity:1" transform="scale(0.26458333)"/>
            </g>
        </g>
    </svg>
</template>

...
cc_library(
    ...
    srcs = glob(
        ...
        exclude = [
            ...
            "cpp/src/arrow/compute/exec/util_avx2.cc",
            "cpp/src/arrow/compute/exec/key_compare_avx2.cc",
            "cpp/src/arrow/compute/exec/key_map_avx2.cc",
            "cpp/src/arrow/compute/exec/key_encode_avx2.cc",
            "cpp/src/arrow/compute/exec/key_hash_avx2.cc",
        ],
    ),
    hdrs = glob([
        "cpp/src/arrow/*.h",
